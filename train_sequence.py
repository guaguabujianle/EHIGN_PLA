...
if __name__ == '__main__':
    ...
    for repeat in range(repeats):
        ...
        train_df = pd.read_csv(os.path.join('./cold_start_data', 'train_sequence_identity.csv'))
        valid_df = pd.read_csv(os.path.join('./cold_start_data', 'valid_sequence_identity.csv'))
        test_df = pd.read_csv(os.path.join('./cold_start_data', 'test_sequence_identity.csv'))
